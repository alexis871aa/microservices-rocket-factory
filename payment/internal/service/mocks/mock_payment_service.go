...
import (
	...
	service "github.com/alexis871aa/microservices-rocket-factory/payment/internal/service"
...
func (_m *PaymentService) PayOrder(ctx context.Context, orderUUID string, userUUID string, paymentMethod service.PaymentMethod) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, service.PaymentMethod) (string, error)); ok {
		return rf(ctx, orderUUID, userUUID, paymentMethod)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, service.PaymentMethod) string); ok {
		r0 = rf(ctx, orderUUID, userUUID, paymentMethod)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, service.PaymentMethod) error); ok {
...
func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, orderUUID string, userUUID string, paymentMethod service.PaymentMethod)) *PaymentService_PayOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(service.PaymentMethod))
	})
	return _c
}
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context, string, string, service.PaymentMethod) (string, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
