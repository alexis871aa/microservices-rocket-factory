...
func (_m *OrderRepository) Delete(ctx context.Context, orderUUID string) error {
...
//   - ctx context.Context
//   - orderUUID string
func (_e *OrderRepository_Expecter) Delete(ctx interface{}, orderUUID interface{}) *OrderRepository_Delete_Call {
	return &OrderRepository_Delete_Call{Call: _e.mock.On("Delete", ctx, orderUUID)}
}

func (_c *OrderRepository_Delete_Call) Run(run func(ctx context.Context, orderUUID string)) *OrderRepository_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *OrderRepository) Update(ctx context.Context, orderUUID string, newOrder model.Order) error {
...
func (_c *OrderRepository_Update_Call) Run(run func(ctx context.Context, orderUUID string, newOrder model.Order)) *OrderRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
