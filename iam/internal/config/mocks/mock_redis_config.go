...
// CacheTTL provides a mock function with no fields
func (_m *RedisConfig) CacheTTL() time.Duration {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CacheTTL")
	}
...
// RedisConfig_CacheTTL_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CacheTTL'
type RedisConfig_CacheTTL_Call struct {
	*mock.Call
}

// CacheTTL is a helper method to define mock.On call
func (_e *RedisConfig_Expecter) CacheTTL() *RedisConfig_CacheTTL_Call {
	return &RedisConfig_CacheTTL_Call{Call: _e.mock.On("CacheTTL")}
}

func (_c *RedisConfig_CacheTTL_Call) Run(run func()) *RedisConfig_CacheTTL_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *RedisConfig_CacheTTL_Call) Return(_a0 time.Duration) *RedisConfig_CacheTTL_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RedisConfig_CacheTTL_Call) RunAndReturn(run func() time.Duration) *RedisConfig_CacheTTL_Call {
	_c.Call.Return(run)
	return _c
}
