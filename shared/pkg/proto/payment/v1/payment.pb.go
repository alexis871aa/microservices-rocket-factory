...
const (
	PaymentMethod_UNKNOWN        PaymentMethod = 0 // неизвестный способ
	PaymentMethod_CARD           PaymentMethod = 1 // банковская карта
	PaymentMethod_SBP            PaymentMethod = 2 // система быстрых платежей
	PaymentMethod_CREDIT_CARD    PaymentMethod = 3 // кредитная карта
	PaymentMethod_INVESTOR_MONEY PaymentMethod = 4 // деньги инвестора (внутренний метод)
)
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB+Z)../shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
