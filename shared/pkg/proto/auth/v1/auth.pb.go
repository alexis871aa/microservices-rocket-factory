...
import (
	v1 "github.com/alexis871aa/microservices-rocket-factory/shared/pkg/proto/common/v1"
...
type WhoamiResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Session       *v1.Session            `protobuf:"bytes,1,opt,name=session,proto3" json:"session,omitempty"` // Информация о текущей сесии
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x06Whoami\x12\x16.auth.v1.WhoamiRequest\x1a\x17.auth.v1.WhoamiResponseBVZTgithub.com/alexis871aa/microservices-rocket-factory/shared/pkg/proto/auth/v1;auth_v1b\x06proto3"
