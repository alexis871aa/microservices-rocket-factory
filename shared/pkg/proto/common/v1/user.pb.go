...
type NotificationMethod struct {
	...
	ProviderName  string                 `protobuf:"bytes,1,opt,name=provider_name,json=providerName,proto3" json:"provider_name,omitempty"` // Провайдер: telegram, email, push
...
const file_common_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtBZZXgithub.com/alexis871aa/microservices-rocket-factory/shared/pkg/proto/common/v1;common_v1b\x06proto3"
