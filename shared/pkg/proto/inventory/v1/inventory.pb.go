...
const (
	Category_UNKNOWN  Category = 0 // неизвестная категория
	Category_ENGINE   Category = 1 // двигатель
	Category_FUEL     Category = 2 // топливо
	Category_PORTHOLE Category = 3 // иллюминатор
	Category_WING     Category = 4 // крыло
)
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB/Z-../shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
